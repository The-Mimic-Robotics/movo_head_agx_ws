...
bool kinova_msgs__msg__cartesian_force__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kinova_msgs.msg._cartesian_force.CartesianForce", full_classname_dest, 47) == 0);
  }
  kinova_msgs__msg__CartesianForce * ros_message = _ros_message;
  {  // force_x
...
{
  /* NOTE(esteve): Call constructor of CartesianForce */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kinova_msgs.msg._cartesian_force");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CartesianForce");
