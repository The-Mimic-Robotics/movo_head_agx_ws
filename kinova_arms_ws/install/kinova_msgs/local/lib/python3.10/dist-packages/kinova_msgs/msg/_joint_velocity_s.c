...
bool kinova_msgs__msg__joint_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kinova_msgs.msg._joint_velocity.JointVelocity", full_classname_dest, 45) == 0);
  }
  kinova_msgs__msg__JointVelocity * ros_message = _ros_message;
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of JointVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kinova_msgs.msg._joint_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointVelocity");
