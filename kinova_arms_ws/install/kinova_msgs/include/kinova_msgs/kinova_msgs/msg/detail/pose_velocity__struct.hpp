...
#ifndef KINOVA_MSGS__MSG__DETAIL__POSE_VELOCITY__STRUCT_HPP_
#define KINOVA_MSGS__MSG__DETAIL__POSE_VELOCITY__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__kinova_msgs__msg__PoseVelocity __attribute__((deprecated))
#else
# define DEPRECATED__kinova_msgs__msg__PoseVelocity __declspec(deprecated)
#endif
...
struct PoseVelocity_
{
  ...
  // pointer types
  using RawPtr =
    kinova_msgs::msg::PoseVelocity_<ContainerAllocator> *;
  using ConstRawPtr =
    const kinova_msgs::msg::PoseVelocity_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      kinova_msgs::msg::PoseVelocity_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__kinova_msgs__msg__PoseVelocity
    std::shared_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__kinova_msgs__msg__PoseVelocity
    std::shared_ptr<kinova_msgs::msg::PoseVelocity_<ContainerAllocator> const>
...
using PoseVelocity =
  kinova_msgs::msg::PoseVelocity_<std::allocator<void>>;
...
#endif  // KINOVA_MSGS__MSG__DETAIL__POSE_VELOCITY__STRUCT_HPP_
