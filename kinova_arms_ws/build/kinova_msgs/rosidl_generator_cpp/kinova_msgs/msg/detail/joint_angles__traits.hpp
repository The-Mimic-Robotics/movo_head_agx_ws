...
#ifndef KINOVA_MSGS__MSG__DETAIL__JOINT_ANGLES__TRAITS_HPP_
#define KINOVA_MSGS__MSG__DETAIL__JOINT_ANGLES__TRAITS_HPP_
...
inline void to_yaml(
  const kinova_msgs::msg::JointAngles & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const kinova_msgs::msg::JointAngles & msg)
{
  return kinova_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<kinova_msgs::msg::JointAngles>()
{
  return "kinova_msgs::msg::JointAngles";
}

template<>
inline const char * name<kinova_msgs::msg::JointAngles>()
{
  return "kinova_msgs/msg/JointAngles";
}

template<>
struct has_fixed_size<kinova_msgs::msg::JointAngles>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<kinova_msgs::msg::JointAngles>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<kinova_msgs::msg::JointAngles>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // KINOVA_MSGS__MSG__DETAIL__JOINT_ANGLES__TRAITS_HPP_
