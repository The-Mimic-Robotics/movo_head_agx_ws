...
#include "kinova_msgs/msg/detail/joint_angles__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kinova_msgs::msg::JointAngles & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kinova_msgs::msg::JointAngles & ros_message)
{
  // Member: joint1
  cdr >> ros_message.joint1;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinova_msgs::msg::JointAngles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinova_msgs::msg::JointAngles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinova_msgs::msg::JointAngles *>(
    untyped_ros_message);
...
{
  return &kinova_msgs::msg::typesupport_fastrtps_cpp::_JointAngles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kinova_msgs, msg, JointAngles)() {
  return &kinova_msgs::msg::typesupport_fastrtps_cpp::_JointAngles__handle;
}
