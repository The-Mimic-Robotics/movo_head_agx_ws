...
class Metaclass_JointVelocity(type):
    """Metaclass of message 'JointVelocity'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_velocity
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_velocity
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_velocity
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_velocity
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_velocity
...
class JointVelocity(metaclass=Metaclass_JointVelocity):
    """Message class 'JointVelocity'."""
    ...
    def joint7(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'joint7' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._joint7 = value
