...
bool kinova_msgs__msg__joint_torque__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kinova_msgs.msg._joint_torque.JointTorque", full_classname_dest, 41) == 0);
  }
  kinova_msgs__msg__JointTorque * ros_message = _ros_message;
  {  // joint1
  ...
  {  // joint7
    ...
    assert(PyFloat_Check(field));
    ros_message->joint7 = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of JointTorque */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("kinova_msgs.msg._joint_torque");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointTorque");
