...
static const _CartesianForce_type_support_symbol_names_t _CartesianForce_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kinova_msgs, msg, CartesianForce)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kinova_msgs, msg, CartesianForce)),
  }
};
...
{
  return &::kinova_msgs::msg::rosidl_typesupport_cpp::CartesianForce_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kinova_msgs, msg, CartesianForce)() {
  return get_message_type_support_handle<kinova_msgs::msg::CartesianForce>();
}
