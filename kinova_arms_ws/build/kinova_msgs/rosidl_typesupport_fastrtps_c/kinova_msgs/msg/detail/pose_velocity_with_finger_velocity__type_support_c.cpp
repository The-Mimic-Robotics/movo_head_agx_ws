...
#include "kinova_msgs/msg/detail/pose_velocity_with_finger_velocity__rosidl_typesupport_fastrtps_c.h"
...
using _PoseVelocityWithFingerVelocity__ros_msg_type = kinova_msgs__msg__PoseVelocityWithFingerVelocity;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PoseVelocityWithFingerVelocity__ros_msg_type * ros_message = static_cast<const _PoseVelocityWithFingerVelocity__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PoseVelocityWithFingerVelocity__ros_msg_type * ros_message = static_cast<_PoseVelocityWithFingerVelocity__ros_msg_type *>(untyped_ros_message);
  // Field name: twist_linear_x
  {
    cdr >> ros_message->twist_linear_x;
  }
...
size_t get_serialized_size_kinova_msgs__msg__PoseVelocityWithFingerVelocity(
  const void * untyped_ros_message,
...
static uint32_t _PoseVelocityWithFingerVelocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kinova_msgs__msg__PoseVelocityWithFingerVelocity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kinova_msgs
size_t max_serialized_size_kinova_msgs__msg__PoseVelocityWithFingerVelocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinova_msgs__msg__PoseVelocityWithFingerVelocity;
    is_plain =
      (
...
static size_t _PoseVelocityWithFingerVelocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kinova_msgs__msg__PoseVelocityWithFingerVelocity(
...
static message_type_support_callbacks_t __callbacks_PoseVelocityWithFingerVelocity = {
  "kinova_msgs::msg",
...
static rosidl_message_type_support_t _PoseVelocityWithFingerVelocity__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PoseVelocityWithFingerVelocity,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinova_msgs, msg, PoseVelocityWithFingerVelocity)() {
  return &_PoseVelocityWithFingerVelocity__type_support;
}
