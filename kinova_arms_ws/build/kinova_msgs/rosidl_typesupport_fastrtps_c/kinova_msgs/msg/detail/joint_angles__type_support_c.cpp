...
#include "kinova_msgs/msg/detail/joint_angles__rosidl_typesupport_fastrtps_c.h"
...
using _JointAngles__ros_msg_type = kinova_msgs__msg__JointAngles;
...
static uint32_t _JointAngles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kinova_msgs__msg__JointAngles(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinova_msgs__msg__JointAngles;
    is_plain =
      (
...
static size_t _JointAngles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kinova_msgs__msg__JointAngles(
