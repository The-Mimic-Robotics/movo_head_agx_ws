...
def generate_launch_description():
    ...
    movo_linear_axis_map_arg = DeclareLaunchArgument(
        "movo_linear_axis_map", default_value="",
        description="Override home_joints.yaml movo_linear_axis_map for this arm; empty = use YAML",
    )
    teleop_axis_arg = DeclareLaunchArgument(
        "teleop_axis", default_value="",
        description="Deprecated; use movo_linear_axis_map. Ignored if movo_linear_axis_map is set.",
    )
    ...
    teleop_node = Node(
        ...
        parameters=[{
            ...
            "movo_linear_axis_map": LaunchConfiguration("movo_linear_axis_map"),
